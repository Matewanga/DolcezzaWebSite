...
export function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const dataToSend = {
      ...formData,
      time: new Date().toLocaleString("pt-BR"), // <-- NECESSÁRIO PARA O TEMPLATE
    };

    emailjs
      .send(
        "service_53l9dea",   // coloque o seu
        "template_uklmc6e",  // coloque o seu
        dataToSend,
        "vsJDKbGGd_w2ZWGP0"    // coloque o seu
      )
      .then(() => {
      ...
      <div className="contact-container">
        ...
        <div className="contact-cards">
          <div className="contact-card">
            ...
            <p>(11) 98765-4321</p>
            <p>(11) 3456-7890</p>
            <button className="card-btn">Ligar Agora →</button>
          </div>
          ...
          <div className="contact-card">
            ...
            <p>dolcezzaa.2000@gmail.com</p>
            <button className="card-btn">Enviar E-mail →</button>
          </div>
          ...
          <div className="contact-card">
            ...
            <button className="card-btn">Ver no Mapa →</button>
          </div>
